import {searchNodeArrayForCharaAndPoint} from '../searchNodeArrForCharaAndPoint'
...
const searchCharaArrayForCharaToSO=(charaArray, tmpName, bunsetsu,bun)=> {
  //文中で登場人物を見つける。
  let resultNode = searchNodeArrayForCharaAndPoint(charaArray, tmpName)
  if (resultNode.isCharacter) {
    ...
    resultNode = searchNodeArrayForCharaAndPoint(charaArray, tmpCharaNameWithHonorific)
    if (resultNode.isCharacter) {
