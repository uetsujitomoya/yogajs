    ...
    while (wordsCntAfterMorphologicalAnalysis < wordsArrayAfterMorphologicalAnalysis.length) {
      ...
      while (wordsCntAfterMorphologicalAnalysis < wordsArrayAfterMorphologicalAnalysis.length) {
        ...
        while (wordsCntAfterMorphologicalAnalysis < wordsArrayAfterMorphologicalAnalysis.length) {
          ...
          if (wordsArrayAfterMorphologicalAnalysis[wordsCntAfterMorphologicalAnalysis].basic_form == '。' || wordsArrayAfterMorphologicalAnalysis[wordsCntAfterMorphologicalAnalysis].basic_form == '？' || wordsArrayAfterMorphologicalAnalysis[wordsCntAfterMorphologicalAnalysis].basic_form == '?' || wordsArrayAfterMorphologicalAnalysis[wordsCntAfterMorphologicalAnalysis].basic_form == '：' || wordsArrayAfterMorphologicalAnalysis[wordsCntAfterMorphologicalAnalysis].basic_form == ':' || wordsArrayAfterMorphologicalAnalysis[wordsCntAfterMorphologicalAnalysis].word_id == '2613630' || wordsArrayAfterMorphologicalAnalysis[wordsCntAfterMorphologicalAnalysis].surfaceForm == '･･･？：' || wordsArrayAfterMorphologicalAnalysis[wordsCntAfterMorphologicalAnalysis].surfaceForm == ')：' ||
                        wordsArrayAfterMorphologicalAnalysis[wordsCntAfterMorphologicalAnalysis].surfaceForm == '…' || wordsArrayAfterMorphologicalAnalysis[wordsCntAfterMorphologicalAnalysis].surfaceForm == '……' || wordsArrayAfterMorphologicalAnalysis[wordsCntAfterMorphologicalAnalysis].surfaceForm == '・・・' || wordsArrayAfterMorphologicalAnalysis[wordsCntAfterMorphologicalAnalysis].surfaceForm == '･･･' || wordsArrayAfterMorphologicalAnalysis[wordsCntAfterMorphologicalAnalysis].surfaceForm.indexOf('〈') != -1 || wordsArrayAfterMorphologicalAnalysis[wordsCntAfterMorphologicalAnalysis].surfaceForm.indexOf('〉') != -1) {
            break
          }
          if (hatsugenCnt % 2 == 1) {
            kanjatango++
            kanjamoji = kanjamoji + wordsArrayAfterMorphologicalAnalysis[wordsCntAfterMorphologicalAnalysis].surfaceForm.length
            ...
            serapitango++
            serapimoji = serapimoji + wordsArrayAfterMorphologicalAnalysis[wordsCntAfterMorphologicalAnalysis].surfaceForm.length
            if (wordsArrayAfterMorphologicalAnalysis[wordsCntAfterMorphologicalAnalysis].surfaceForm == 'そう' && wordsArrayAfterMorphologicalAnalysis[wordsCntAfterMorphologicalAnalysis + 1].surfaceForm == 'です' && wordsArrayAfterMorphologicalAnalysis[wordsCntAfterMorphologicalAnalysis + 2].surfaceForm == 'か') {
              soudesuka++
            }
            if (wordsArrayAfterMorphologicalAnalysis[wordsCntAfterMorphologicalAnalysis].surfaceForm == '何' && wordsArrayAfterMorphologicalAnalysis[wordsCntAfterMorphologicalAnalysis + 1].surfaceForm == 'か') {

            } else if (wordsArrayAfterMorphologicalAnalysis[wordsCntAfterMorphologicalAnalysis].basic_form == 'いかが' || wordsArrayAfterMorphologicalAnalysis[wordsCntAfterMorphologicalAnalysis].basic_form == 'なんで' || wordsArrayAfterMorphologicalAnalysis[wordsCntAfterMorphologicalAnalysis].basic_form == 'どうして' || wordsArrayAfterMorphologicalAnalysis[wordsCntAfterMorphologicalAnalysis].basic_form == 'どの' || wordsArrayAfterMorphologicalAnalysis[wordsCntAfterMorphologicalAnalysis].basic_form == 'どのように' || wordsArrayAfterMorphologicalAnalysis[wordsCntAfterMorphologicalAnalysis].basic_form == 'いつ' || wordsArrayAfterMorphologicalAnalysis[wordsCntAfterMorphologicalAnalysis].basic_form == 'どういう' || wordsArrayAfterMorphologicalAnalysis[wordsCntAfterMorphologicalAnalysis].basic_form == 'どなた' || wordsArrayAfterMorphologicalAnalysis[wordsCntAfterMorphologicalAnalysis].basic_form == 'どう' || wordsArrayAfterMorphologicalAnalysis[wordsCntAfterMorphologicalAnalysis].surfaceForm == '何' || wordsArrayAfterMorphologicalAnalysis[wordsCntAfterMorphologicalAnalysis].basic_form == '誰' || wordsArrayAfterMorphologicalAnalysis[wordsCntAfterMorphologicalAnalysis].basic_form == 'どんな' || wordsArrayAfterMorphologicalAnalysis[wordsCntAfterMorphologicalAnalysis].basic_form == 'どのような' || wordsArrayAfterMorphologicalAnalysis[wordsCntAfterMorphologicalAnalysis].basic_form == 'どこ') {
              RGBlist[hatsugenCnt / 2][3] = 1
            } else if (wordsArrayAfterMorphologicalAnalysis[wordsCntAfterMorphologicalAnalysis].surfaceForm == 'か' && wordsArrayAfterMorphologicalAnalysis[wordsCntAfterMorphologicalAnalysis].pos == '助詞') {
                RGBlist[hatsugenCnt / 2][4] = 1
              } else if (wordsArrayAfterMorphologicalAnalysis[wordsCntAfterMorphologicalAnalysis].surfaceForm == 'ね' && wordsArrayAfterMorphologicalAnalysis[wordsCntAfterMorphologicalAnalysis].pos == '助詞') {
                  RGBlist[hatsugenCnt / 2][6] = 1
                }
          }
          contentArrayOfASentence[hatsugenCnt][sentenceCntInHatsugen] += wordsArrayAfterMorphologicalAnalysis[wordsCntAfterMorphologicalAnalysis].surfaceForm
        ...
        if (wordsArrayAfterMorphologicalAnalysis[wordsCntAfterMorphologicalAnalysis].word_id == '2613630' || wordsArrayAfterMorphologicalAnalysis[wordsCntAfterMorphologicalAnalysis].basic_form == '：' || wordsArrayAfterMorphologicalAnalysis[wordsCntAfterMorphologicalAnalysis].basic_form == ':' || wordsArrayAfterMorphologicalAnalysis[wordsCntAfterMorphologicalAnalysis].surfaceForm == '･･･？：' || wordsArrayAfterMorphologicalAnalysis[wordsCntAfterMorphologicalAnalysis].surfaceForm == ')：' || wordsArrayAfterMorphologicalAnalysis[wordsCntAfterMorphologicalAnalysis].surfaceForm.indexOf('〈') != -1 || wordsArrayAfterMorphologicalAnalysis[wordsCntAfterMorphologicalAnalysis].surfaceForm.indexOf('〉') != -1) {
          if (hatsugenCnt % 2 == 0) {
            if (sentenceCntInHatsugen <= 2 && wordsQtyInASentence <= 7) {
              RGBlist[hatsugenCnt / 2][5] = 1
            }
