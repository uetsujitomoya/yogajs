...
let isTurnEnd=(elementOfPath)=>{
    if(elementOfPath.word_id=="2613630"||elementOfPath.basic_form=="："||elementOfPath.basic_form==":"||elementOfPath.surface_form=="･･･？："||elementOfPath.surface_form==")："||elementOfPath.surface_form.indexOf('〈') != -1||elementOfPath.surface_form.indexOf('〉') != -1){
        return 1;
    }
    return 0;
};
