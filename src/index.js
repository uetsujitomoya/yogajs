							...
							if(RGB[m][i][0]+RGB[m][i][1]+RGB[m][i][2]>=1){
								...
								if(RGB[m][i][0]==1){
									//if(checkboxlist[k][1]==0){単語とグループの組み合わせの重複を防ぐ
										target.innerHTML += "<input id=\"ken" + c + "\" type=checkbox /><label for="+c+">「" + keitaisokaiseki[m][i][j] + "」を「愛(恋愛･家族関係)」に。</label><br />";
										console.log("%d,%d,%d,「%s」を「愛」に",m,i,j,keitaisokaiseki[m][i][j]);
										
										//checkboxlist[k][0]=1;
										//checkboxlist[k][1]=1;
										chboxlist[c]=new Array(2);
										chboxlist[c][0]=keitaisokaiseki[m][i][j];
										console.log("c=%d",c);
										chboxlist[c][1]=0;
										c++;
									//}
								...
								if(RGB[m][i][1]==1){
									//if(checkboxlist[k][2]==0){
										target.innerHTML += "<input id=\"ken" + c + "\" type=checkbox /><label for="+c+">「" + keitaisokaiseki[m][i][j] + "」を「交友関係」に。</label><br />";
										console.log("%d,%d,%d,「%s」を「交友」に",m,i,j,keitaisokaiseki[m][i][j]);
								...
								if(RGB[m][i][2]==1){
									//if(checkboxlist[k][3]==0){
										target.innerHTML += "<input id=\"ken" + c + "\" type=checkbox /><label for="+c+">「" + keitaisokaiseki[m][i][j] + "」を「仕事関係」に。</label><br />";
										console.log("%d,%d,%d,「%s」を「仕事」に",m,i,j,keitaisokaiseki[m][i][j]);
