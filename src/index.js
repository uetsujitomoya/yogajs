...
document.getElementById('load-button').addEventListener('click', function () {
  ...
  reader.onload = function(event) {
    console.log(event);
    funcReaderOnload(event,keitaisokaiseki,checkboxlist,chboxlist,chboxlist2,RGBlist,hatsugen,bun);
    
    document.getElementById('radio_buttons').onchange = () => {
    	setForViz(keitaisokaiseki,checkboxlist,chboxlist,chboxlist2,RGBlist,hatsugen,bun);
    };
    //checkbox依存部分終わり
